...
//     $url = research_URL_API."Setting/GetWhereList?tg_id=$tg_id&fun_id=".FUNC_LIST_research."&p_id=".$p_id."&pattern_no=".$pattern_no;
//     $getSetting = research_get_api_common($post_id, $url, array(), "GET");
//     return $getSetting;
//   }
//
//   public static function research_postSettingWhere($post_id, $param){
//     $url = research_URL_API."Setting/SetListWhere";
//     $post = get_post();
...
//     $tg_id = $param_tg_id;
//     $p_id = research_PREFIX_P_ID.FUNC_LIST_research.$tg_id."_".$pattern_no;
//     $url = research_URL_API."Setting/GetSettingList?tg_id=$tg_id&fun_id=".FUNC_LIST_research."&p_id=".$p_id."&pattern_no=".$pattern_no;
//     $getSetting = research_get_api_common($post_id, $url, array(), "GET");
//     return $getSetting;
//   }
//
...
//     $tg_id = get_post_meta($post->ID, 'top_g_id', true);
//     $pattern_no = get_post_meta($post->ID, 'pattern_no_post_type', true);
//     $url = research_URL_API."Setting/SetListDisPlay";
//     $p_id = research_PREFIX_P_ID.FUNC_LIST_research.$tg_id."_".$pattern_no;
//     $param = array(
//       "TG_ID"=> $tg_id,
//       "P_ID"=> $p_id,
...
//     $tg_id = $param_tg_id;
//     $p_id = research_PREFIX_P_ID.FUNC_LIST_research.$tg_id."_".$pattern_no;
//     $url = research_URL_API."/Setting/GetSortList?tg_id=$tg_id&fun_id=".FUNC_LIST_research."&p_id=".$p_id."&pattern_no=".$pattern_no;
//     $getSettingSort = research_get_api_common($post_id, $url, array(), "GET");
//     return $getSettingSort;
//   }
//
   public static function service_postSettingSort($post_id, $arrItem){
     $url = SErvice_."Setting/SetListDisOrder";
...
//     $url = research_URL_API."Member/GetSta?tg_id=".$tg_id;
