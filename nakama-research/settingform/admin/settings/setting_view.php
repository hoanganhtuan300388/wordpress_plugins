...
$dataGet = researchCrSet::research_GetSettingLists($postid, $tgid,$pattern_no);
...
<div class="per_page">
  <label>一覧表示件数 :</label>
  <select name="nak-research-per-page" class="">
    <?php
      $current_per_page =  get_post_meta($postid, 'nak-research-per-page', true);
      if($current_per_page == ''){
...
<div class="jp-multiselect">
  ...
  <div class="to-panel col-5-dual left">
    <h4>現在の項目</h4>
    <select id="selected" name="nak-research-key-list-show[]" class="selected form-control" style="height: 250px; width: 100%; overflow-y: auto;" multiple="multiple">
