...
if(!isset($_SESSION['arrSession'])){
  ...
  $header_file = $dataSetting["disp_header_file_reg_end"][0];
  $file_ini = $dataSetting["disp_merumaga_file_end"][0];
  $disp_FeeStatus = $dataSetting["entry_setting5_end"][0];
  $checkDataGroup = $members->getGroupsOfUser($postid);
  $page_link_gr = $members->getPageSlug('nakama-member-list-group');
  // echo "checkDataGroup = ";
  // echo "<br>";
  // var_dump($checkDataGroup);
  // echo "<br>";
  // echo "checkDataGroup->Count = " . $checkDataGroup->Count . "<br>";
  // echo "_SESSION['flag_Group'] = " . $_SESSION['flag_Group'] . "<br>";
  // echo "_SESSION['post_id'] = " . $_SESSION['post_id'] . "<br>";
  // echo "postid = " . $postid . "<br>";
 if($checkDataGroup->Count > 1 && $_SESSION['flag_Group'] != 1 && $_SESSION['post_id'] != $postid) {
    ?>
  <script>window.location = "<?php echo $page_link_gr.'path='.$path_page.'&post_id='.$postid; ?>"; </script>
  <?php
  } else {
    // if(!$_SESSION['LG_NAME']){
    // 	$_SESSION['LG_NAME'] = isset($checkDataGroup->data[0]->LG_NAME) ? $checkDataGroup->data[0]->LG_NAME : "";
    // }
    $_SESSION['flag_Group'] = 0;
    $_SESSION['post_id'] = $postid;
  }
  if($checkDataGroup->Count == 1){
  	$_SESSION['LG_NAME'] = $checkDataGroup->data[0]->LG_NAME;
  	$_SESSION['arrSession']->LG_ID = $checkDataGroup->data[0]->LG_ID;
  	$_SESSION['arrSession']->M_ID = $checkDataGroup->data[0]->M_ID;
  }
  ...
  if($_POST){
    ...
    $_SESSION['arrUpdate'] = $_POST;
    uploadFile($_POST['G_G_ID']);
    ?>
    <script>window.location = "<?php echo get_permalink(get_page_by_path('nakama-update-confirm')->ID); ?>"; </script>
    <?php
  }
}
?>
...
<head>
  ...
  <script type="text/javascript">
    ...
    function gdCheckInputData(bChange){
        ...
        if(form.G_EMAIL != undefined && form.G_EMAIL.type != "hidden"){
        ...
        if((form.G_FOUND_YEAR.value != "") || (form.G_FOUND_MONTH.value != "") || (form.G_FOUND_DAY.value != "")){
          if(IsDateImp(form.m_foundImperialG.value, form.G_FOUND_YEAR, form.G_FOUND_MONTH, form.G_FOUND_DAY, "<?php echo $members->convertNvl(str_replace("<br>", "",$members->renderTitle("設立年月日")), "設立年月日"); ?>")){
            return false;
          }
    ...
    function mdCheckInputData(bMDReg){
        ...
        if(form.M_WITHDRAWAL_DATE_Y != undefined){
          if(form.M_WITHDRAWAL_DATE_Y.type != "hidden"){
            if((form.M_WITHDRAWAL_DATE_Y.value != "") || (form.M_WITHDRAWAL_DATE_M.value != "") || (form.M_WITHDRAWAL_DATE_D.value != "")){
              if(IsDateImp(form.m_witImperialM.value, form.M_WITHDRAWAL_DATE_Y, form.M_WITHDRAWAL_DATE_M, form.M_WITHDRAWAL_DATE_D, "<?php echo $members->convertNvl(str_replace("<br>", "",$members->renderTitle("異動年月日")), "異動年月日"); ?>")){
                return false;
              }
        ...
        if(form.M_CONTACT_EMAIL != undefined){
          if(form.M_CONTACT_EMAIL.type != "hidden"){
            ...
            if(isMail(form.M_CONTACT_EMAIL.value, "<?php echo $members->convertNvl(str_replace("<br>", "",$members->renderTitle("連絡先E-MAIL")), "連絡先E-MAIL"); ?>")){
              return errProc(form.M_CONTACT_EMAIL);
            }
          }
        }
          ...
          if(form.M_CL_C_TEL_1.type != "hidden"){
            if(form.M_BILLING_ID.value == "2"){
              if(form.M_CL_C_TEL_1.value != "" || form.M_CL_C_TEL_2.value != "" || form.M_CL_C_TEL_3.value != ""){
                ...
                form.M_CLM_BILLING_TEL_C_TEL.value = "";
              }
            }
          }
        }
        ...
        if(form.M_BILLING_ADR_EN != undefined){
          if(form.M_BILLING_ADR_EN.type != "hidden"){
            if(IsLengthB(form.M_BILLING_ADR_EN.value, 0, 1000, "<?php echo $members->convertNvl(str_replace("<br>", "",$members->renderTitle('請求先住所　英語表記')), '請求先住所　英語表記');?>")){
    ...
    function CheckInputData_searver(pdFlg, gdFlg, sdFlg, mdFlg, bChange, bMdReg){
        ...
        var ifmSetUrl;
        var change_flg="0";
        if(form.P_C_EMAIL != undefined && form.P_C_EMAIL.value != "" && form.P_C_EMAIL.value != P_C_EMAIL_OLD){
          $.ajax({
  ...
  <script type="text/javascript">
         ...
         function SetData(){
          ...
          if(form.M_BILLING_ID != undefined){
		   setClaimFormValueNew();
           changeClaimForm();
          }

          if(form.M_CONTACT_ID != undefined){
		   setContactFormValueNew();
           changeContactForm();
          }
         ...
         function OnBankCodeChangeAll(){
          ...
          for (j=1; j<=3; j++) {
           ...
           switch (j) {
            ...
            case 2:
             bankCode = bankCode + ",,";
             if(form.P_BANK_CD != undefined && form.P_BRANCH_CODE != undefined){
              bank = form.P_BANK_CD;
         ...
         function ShowImage(path){
            var page_link = '<?php echo $members->getPageSlug('nakama-member-imgview'); ?>';
            buf = page_link+'path='+path;
           gToolWnd = open(buf,
            'DetailWnd',
            'width=1000,location=no,hotkeys=no,toolbar=no,menubar=no,status=no,scrollbars=yes,personalbar=no,resizable=yes');
         }
...
<body onunload="OnUnload();" onload="OnLoad();">
  ...
  <div class="container update_page">
    ...
    <form name="mainForm" id="mainForm" enctype="multipart/form-data" method="POST" class="mt-15" autocomplete="off">
      ...
      <br>
      <table class="input_table_top" cellspacing="0" cellpadding="3">
        <tbody>
          <tr>
            <td class="RegField">グループ名</td>
            <td class="RegField"><?php echo (isset($_SESSION['LG_NAME']))?$_SESSION['LG_NAME']:""; ?></td>
          </tr>
        </tbody>
      </table><br>
      <?php
        $members->ShowAllData($file_ini,'div_confirm', true, $args['id']);
      ?>
      <script>
      var arrThreeInput = [
      ...
      var label_M_CONTRACT_TYPE = '<?php echo $members->convertNvl(str_replace("<br>", "",$members->getNewTitle($GLOBALS['arTitle'],'連絡手段')), '連絡手段'); ?>';
    </script>
    <br>
    ...
    <input type="hidden" name="strToday"        value="">
    <input type="hidden" name="m_lg_g_id_old"   value="">
    <input type="hidden" name="set_lg_g_id"     value="">
    <input type="hidden" name="set_g_id"        value="<?php echo get_option('set_g_id'); ?>">
    ...
    <input type="hidden" name="clNew_M_CL_C_ADDRESS3"     value="">
    ...
    <input type="hidden" name="coNew_M_CO_C_ADDRESS3"     value="">
  ...
  <script type="text/javascript">
      var form = document.mainForm;
      var P_C_EMAIL_OLD = form.P_C_EMAIL.value;
         ...
         if (form.M_CONTACT_C_NAME != undefined) {
            ...
            switch(contactdest.value) {
			   ...
			   case "@C":
                  ...
                  checkDispIni(form.M_CONTACT_ADR3, form.P_C_ADR3);
			      ...
			      case "@G":
                    ...
                    checkDispIni(form.M_CONTACT_ADR, form.G_ADR);
                    checkDispIni(form.M_CONTACT_ADR2, form.G_ADR2);
                    checkDispIni(form.M_CONTACT_ADR3, form.G_ADR3);
			      ...
			      case "@P":
                    ...
                    checkDispIni(form.M_CONTACT_ADR3, form.P_P_ADR3);
               ...
               if(form.m_chg.value == "1"){
                 ...
                 checkDispBoth(form.M_CONTACT_ADR3   , form.coNew_M_CO_C_ADDRESS3);
               }
         ...
         if (form.M_BILLING_C_NAME != undefined) {
          ...
          switch(claimdest.value) {
			...
			case "@C":
              ...
              checkDispIni(form.M_BILLING_ADR3, form.P_C_ADR3);
              ...
              checkDispIni(form.M_BRANCH_CD, form.P_BRANCH_CODE);
			...
			case "@G":
              ...
              checkDispIni(form.M_BILLING_ADR, form.G_ADR);
              checkDispIni(form.M_BILLING_ADR2, form.G_ADR2);
              checkDispIni(form.M_BILLING_ADR3, form.G_ADR3);
			...
			case "@P":
              ...
              checkDispIni(form.M_BILLING_ADR3, form.P_P_ADR3);
              checkDispIni(form.S_BRANCH_CODE, form.P_BRANCH_CODE);
              checkDispIni(form.M_ACCAUNT_TYPE, form.P_ACCAUNT_TYPE);
              checkDispIni(form.M_ACCOUNT_NO, form.P_ACCOUNT_NO);
              checkDispIni(form.M_ACCOUNT_NM, form.P_ACCOUNT_NM);
			...
			case "@N":
               if(form.m_chg.value == "1"){
                 ...
                 checkDispBoth(form.M_BILLING_ADR3    , form.clNew_M_CL_C_ADDRESS3);
      ...
      function changeContactFormValue(){
        ...
        switch(contactdest.value) {
		  ...
		  case "@C":
            ...
            checkDispBoth(form.P_C_ADR3, form.M_CONTACT_ADR3);
            break;
		  ...
		  case "@G":
            ...
            checkDispBoth(form.G_ADR, form.M_CONTACT_ADR);
            checkDispBoth(form.G_ADR2, form.M_CONTACT_ADR2);
            checkDispBoth(form.G_ADR3, form.M_CONTACT_ADR3);
            break;
		  ...
		  case "@P":
            ...
            checkDispBoth(form.P_P_ADR3, form.M_CONTACT_ADR3);
            break;
        ...
        if(contactdest.value=="@N"){
          ...
          checkDispBoth(form.coNew_M_CO_C_ADDRESS3   , form.M_CONTACT_ADR3);
        }

      }

      function setContactFormValueNew(){
          var form = document.mainForm;
          if (form.M_CONTACT_C_NAME != undefined) {
              checkDispBoth(form.coNew_M_CO_C_NAME       , form.M_CONTACT_C_NAME);
              checkDispBoth(form.coNew_M_CO_C_KANA       , form.M_CONTACT_C_NAME_KN);
      ...
      function changeClaimFormValue(){
        ...
        switch (claimdest.value) {
		  ...
		  case "@C":
            ...
            checkDispBoth(form.P_C_ADR3, form.M_BILLING_ADR3);
            checkDispBoth(form.P_BRANCH_CODE, form.M_BRANCH_CD);
            ...
            OnBankCodeChange(form.M_BANK_CD, form.P_BRANCH_CODE, '2');
            checkDispIni(form.P_BANK_SET_NAME, form.M_BANK_CD);
            checkDispIni(form.P_BRANCH_SET_NAME, form.M_BRANCH_CD);
            setTimeout("checkDispIni(document.mainForm.P_BRANCH_CODE, document.mainForm.M_BRANCH_CD)", 1000);
            break;
		  ...
		  case "@G":
            ...
            checkDispBoth(form.G_ADR, form.M_BILLING_ADR);
            checkDispBoth(form.G_ADR2, form.M_BILLING_ADR2);
            checkDispBoth(form.G_ADR3, form.M_BILLING_ADR3);
		  ...
		  case "@P":
            ...
            checkDispBoth(form.P_P_ADR3, form.M_BILLING_ADR3);
            checkDispBoth(form.P_ACCAUNT_TYPE, form.M_ACCAUNT_TYPE);
            checkDispBoth(form.P_ACCOUNT_NO, form.M_ACCOUNT_NO);
            checkDispBoth(form.P_ACCOUNT_NM, form.M_ACCOUNT_NM);
            checkDispBoth(form.P_CUST_NO, form.M_CUST_NO);
        ...
        if(claimdest.value=="@N"){
          ...
          checkDispBoth(form.clNew_M_CL_C_ADDRESS3    , form.M_BILLING_ADR3);
      ...
      function changeContactFormDisp(){
        ...
        // if ((contactdest.value == "@P") && (claimdest.value == "@P")) {
      ...
      function setContactDisabled(){
        ...
        checkDispReadOnly(form.M_CONTACT_ADR3    , true);
        checkDispReadOnly(form.M_CONTACT_AFFILIATION , true);
        checkDispReadOnly(form.M_CONTACT_POSITION    , true);
        ...
        checkDispColor(form.M_CONTACT_ADR3     , "#FFFFCC");
        checkDispColor(form.M_CONTACT_AFFILIATION  , "#FFFFCC");
        checkDispColor(form.M_CONTACT_POSITION     , "#FFFFCC");
      ...
      function setBillingDisabled(){
        ...
        checkDispReadOnly(form.M_BILLING_ADR3    , true);
        checkDispReadOnly(form.M_BILLING_AFFILIATION , true);
        checkDispReadOnly(form.M_BILLING_POSITION    , true);
        ...
        checkDispColor(form.M_BILLING_ADR3     , "#FFFFCC");
        checkDispColor(form.M_BILLING_AFFILIATION  , "#FFFFCC");
        checkDispColor(form.M_BILLING_POSITION     , "#FFFFCC");
      ...
      function setContactEnabled(){
        ...
        checkDispReadOnly(form.M_CONTACT_ADR3    , false);
        checkDispReadOnly(form.M_CONTACT_AFFILIATION , false);
        checkDispReadOnly(form.M_CONTACT_POSITION    , false);
        ...
        checkDispColor(form.M_CONTACT_ADR3     , "");
        checkDispColor(form.M_CONTACT_AFFILIATION  , "");
        checkDispColor(form.M_CONTACT_POSITION     , "");
      ...
      function setBillingEnabled(){
        ...
        checkDispReadOnly(form.M_BILLING_ADR3    , false);
        checkDispReadOnly(form.M_BILLING_AFFILIATION , false);
        checkDispReadOnly(form.M_BILLING_POSITION    , false);
        ...
        checkDispColor(form.M_BILLING_ADR3     , "");
        checkDispColor(form.M_BILLING_AFFILIATION  , "");
        checkDispColor(form.M_BILLING_POSITION     , "");
