  ...
  if(form.G_PASSWORD != undefined){
    if(form.G_PASSWORD.type != "hidden"){
      ...
      if(form.G_PASSWORD.type != "text"){
        $('input[name="G_PASSWORD"]').replaceWith('<input style="ime-mode: disabled;" type="text" name="G_PASSWORD" value="' + tmpVal1 + '">');
        $('input[name="G_PASSWORD2"]').replaceWith('<input style="ime-mode: disabled;" type="text" name="G_PASSWORD2" value="' + tmpVal2 + '">');
        form.dispGPassBtn.value = "パスワード非表示";
      }else{
        $('input[name="G_PASSWORD"]').replaceWith('<input style="ime-mode: disabled;" type="password" name="G_PASSWORD" value="' + tmpVal1 + '">');
        $('input[name="G_PASSWORD2"]').replaceWith('<input style="ime-mode: disabled;" type="password" name="G_PASSWORD2" value="' + tmpVal2 + '">');
...
function CheckInputData_searver(pdFlg, gdFlg, sdFlg, mdFlg, bChange, bMdReg){
  var form = document.mainForm;
  if(form.P_C_EMAIL.value != "" && form.P_C_EMAIL.value != form.P_C_EMAIL_hidden.value){
    $.ajax({
